  ...
  <div class="container">
    <?php if (empty($row2["nama"])): ?>
      <div class="alert alert-warning mt-5 py-3" role="alert">
        Anda belum melengkapi data diri, segera lengkapi data diri anda <a href="newdata.php" class="alert-link">Disini</a>
      </div>
    <?php endif; ?>
    <div class="d-flex mt-5 mb-3">
      <div class="flex-row mr-auto"><h2>List User</h2></div>
